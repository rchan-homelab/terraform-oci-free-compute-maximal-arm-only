...
** Quick-Create Link
   1. Open the following link in your browser (update release tag as needed in the future):
      https://cloud.oracle.com/resourcemanager/stacks/create?zipUrl=https://github.com/rchan-homelab/terraform-oci-free-compute-maximal-arm-only/archive/refs/tags/v1.0.0.zip
